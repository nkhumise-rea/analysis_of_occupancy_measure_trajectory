...
from envs.DQN import gridworld
...
class otdd():
    ...
    def monot(self,ds_col,steps_col,num_eval,state_dis,regret_col,num_curve,outcome,show=0):
        ...
        ## regret_plot
        plt.subplot(2,2,2)
        x_values = np.arange(len(regret_col)) + 64 +1 #batch_size: 64
    ...
    def file_location(self):
        ...
        ## ----- Normal_operation -----
        #common_location
        common_loc = f'dqn_dqn/stop_{self.num_stop}/step_{self.max_esteps}' #SAC
        ...
        common_loc = f'dqn_multiruns/stop_{self.num_stop}/step_{self.max_esteps}' #dqn
